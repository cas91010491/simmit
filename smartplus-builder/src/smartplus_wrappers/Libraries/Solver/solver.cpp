...
void solver(const bp::str &umat_name_py, const bn::ndarray &props, const int &nstatev, const double &rho, const double &c_p, const bp::str &pathfile_py, const bp::str &outputfile_py) {
    ...
    smart::solver(umat_name, v, nstatev, rho, c_p, pathfile, outputfile);
}
