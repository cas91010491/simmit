...
void solver(const bp::str &umat_name_py, const bn::ndarray &props, const int &nstatev, const double &psi_rve, const double &theta_rve, const double &phi_rve, const double &rho, const double &c_p, const bp::str &path_data_py, const bp::str &path_results_py, const bp::str &pathfile_py, const bp::str &outputfile_py) {
    ...
    smart::solver(umat_name, v, nstatev, psi_rve, theta_rve, phi_rve, rho, c_p, path_data, path_results, pathfile, outputfile);
}
